        ...
        let testCases = [
            ...
            TestCase(
                ...
                expectedOps: [
                    .hMessage(
                       HMessageInbound(
                        subject: "foo", sid: 1, payload: nil, headers: hm, headersLength: 30, length: 30)
                    ),
                ]
            ),
            TestCase(
                ...
                expectedOps: [
                    .hMessage(
                        HMessageInbound(
                            subject: "foo", sid: 1, payload: "hello".data(using: .utf8)!, headers: hm, headersLength: 30, length: 35)
                    ),
                ]
            ),
            TestCase(
                ...
                expectedOps: [
                    .hMessage(
                        HMessageInbound(
                            subject: "foo", sid: 1, payload: nil, headers: HeaderMap(), headersLength: 30, length: 30, status: 503, description: "no responders")
                    ),
                ]
            ),
            TestCase(
                ...
                expectedOps: [
                    .hMessage(
                        HMessageInbound(
                            subject: "foo", sid: 1, payload: "hello".data(using: .utf8)!, headers: hm, headersLength: 48, length: 53, status: 503, description: "no responders")
                    ),
                ]
            ),
            TestCase(
